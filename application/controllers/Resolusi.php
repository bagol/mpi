...
class Resolusi extends CI_Controller
{
	...
	function pengaduan(){
		...
		$data['pengaduan'] = $data['pengaduan'] = $this->M_pengaduan->getPengaduan(14)->result_array();
		$this->load->view('template/header', $data);
		$this->load->view('resolusi/pengaduan/index',$data);
		$this->load->view('template/footer');
	}

	function prosesResolusi(){
		$data['title'] = 'Pemeriksa Laporan';
		...
		$this->load->view('template/header', $data);
		$this->load->view('resolusi/solusi/index',$data);
		$this->load->view('template/footer');
		$this->load->view('resolusi/solusi/footer',$data);
	}
