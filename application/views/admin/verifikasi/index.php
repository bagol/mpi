            	...
            	<div class="row">
            		<div class="col-sm-4 ">
            			...
            			<div class="d-flex justify-content-center">
            				<button class="btn btn-primary mr-3" id="identitas_valid">valid</button>
							<button class="btn btn-danger " id="identitas_invalid">invalid</button>
            			</div>
            		...
            		<div class="col-sm-4">
            			...
            			<div class="d-flex justify-content-center">
            				<button class="btn btn-primary mr-3"id="uraian_valid">valid</button>
							<button class="btn btn-danger " id="uraian_invalid">invalid</button>
						</div>
					</div>
            		<div class="col-sm-4">
            			...
            			<div class="d-flex justify-content-center">
            				<button class="btn btn-primary mr-3" id="dokumen_valid">valid</button>
							<button class="btn btn-danger " id="dokumen_invalid">invalid</button>
						</div>
            		</div>
            	</div>
            </div>
            <div class="card-footer">
            	<button class="btn btn-info" id="verif" data-toggle="modal" data-target="#exampleModalVerif">Verifikasi <i class="fa fa-check-square"></i></button>
            </div>
        </div>
	</div>
</div>